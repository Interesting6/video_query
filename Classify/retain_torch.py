...
# torch.save(model, '/root/codes/RemoteWork/Classify/models/mobilenet_v2.pkl')
model = torch.load('/root/codes/RemoteWork/Classify/models/mobilenet_v2.pkl')
...
def train_model(model, criterion, optimizer, scheduler, num_epochs=30):
    ...
    torch.save(model, '/root/codes/RemoteWork/Classify/models/best_model_1.pkl')
